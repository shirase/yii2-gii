...
<?php endif; ?>
    ...
    <p>
        <?= "<?php " ?>if (\Yii::$app->user->can('/'.$this->context->uniqueId.'/create')) echo Html::a(<?= $generator->generateString('Create') ?>, ['create']+$this->context->actionParams, ['class' => 'btn btn-success']) ?>
    </p>
